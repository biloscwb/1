...
<head>
  ...
  <style>
      ...
      #conteudo{ width: 100%; height: 350px; 
             ...
             <div id="dados" class="tab-pane <?php if($aba_selecionada == "dados"){ echo "active"; } ?>" >
               <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">  						
                ...
                <fieldset>
                 ...
                 <div class="form-group">
                  <label class="col-md-12" >SÓ MUDE O TEXTO ABAIXO CASO QUEIRA DESATIVAR UMA PAGINA.</label>
                  <div class="col-md-12">
                ...
                <div class="form-group">
                  <label class="col-md-12">Conteúdo</label>
                    <div class="col-md-12">
                    <textarea class="exit" id="conteudo" name="conteudo" rows="15" ><?=$data->conteudo?></textarea>
                  </div>
                </div>
